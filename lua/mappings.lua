...
wk.add({
    ...
    { "<a-up>", "zc", desc = "[FOLDS] Close fold", nowait = false, remap = false }, { "<a-down>", "zo", desc = "[FOLDS] Open fold", nowait = false, remap = false },
    --------------------------
    ...
    { "<leader>vp", "<cmd>Trouble<cr>", desc = "[TROUBLE] Toggle", nowait = false, remap = false },
